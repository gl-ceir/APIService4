...
public class UserProfileSpecificationBuilder {
	...
	private List<Specification<UserProfile>> specifications;

	private final Logger log = LoggerFactory.getLogger(getClass());
	
	public UserProfileSpecificationBuilder(String dialect) {
		params = new ArrayList<>();
		specifications = new LinkedList<>();
		this.dialect = dialect;
	}

	public final UserProfileSpecificationBuilder with(SearchCriteria criteria) { 
		params.add(criteria);
		return this;
	}
	public void addSpecification(Specification<UserProfile> specification) { 
	...
	private List<Specification<UserProfile>> createSpecifications(){
		...
		for(SearchCriteria searchCriteria : params) {
			...
			log.info("error occur in add specification");
			e.printStackTrace();
