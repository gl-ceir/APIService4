        ...
        try {
          ...
          //  User UserData1;
           // Users UsersData2= new Users();
			...
			/*
			 * if(propertiesReader.dbName.toLowerCase().contains("mysql")) {
			 * log.info("mysql block------->"); UserData =
			 * userRepo.findByUsername(user.getUsername()); //UserData=UserData1;
			 * log.info("UserData------->" + UserData); } else {
			 * log.info("oracle  block------->"); //UsersData2 =
			 * usersRepo.findByUsername(user.getUsername()); //UserData=UsersData2; //
			 * log.info("UserDat++++++++++++++>" + UsersData2); }
			 */
       	  
			/*
			 * if(propertiesReader.dialect.toLowerCase().contains("mysql")) {
			 * log.info("mysql block------->" + UserData); UserData =
			 * userRepo.findByUsername(user.getUsername());
			 * 
			 * log.info("UserData------->" + UserData); } else {
			 * log.info("oracle  block------->" + UserData); UserData =
			 * usersRepo.findByUsername(user.getUsername());
			 * 
			 * log.info("UserDat++++++++++++++>" + UserData); }
			 */
