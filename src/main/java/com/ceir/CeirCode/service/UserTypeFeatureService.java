			...
			if(operation.equals("Export")) {
			  ...
			  orderColumn = "Created On".equalsIgnoreCase(filterRequest.getOrderColumnName()) ? "createdOn" :
				  				   		"Modified On".equalsIgnoreCase(filterRequest.getOrderColumnName()) ? "modifiedOn" :
				  				   			"User Type".equalsIgnoreCase(filterRequest.getOrderColumnName()) ? "userTypeFeature" :
				  				   				"Feature".equalsIgnoreCase(filterRequest.getOrderColumnName()) ? "stakeholderFeature" :
				  				   					"Period".equalsIgnoreCase(filterRequest.getOrderColumnName()) ? "period"
				  				   							:"modifiedOn"; 
			}
