...
import com.ceir.CeirCode.repo.SystemConfigurationDbRepository;
...
public class JwtServiceImpl {
	...
	public String extractUsername(String token) {
	  ...
	  public String generateToken(
	    ...
	    return Jwts
	        .builder()
	        .setId("CEIR"+userDetails.getUsername()+currentTime)
	        ...
	        .setExpiration(new Date(System.currentTimeMillis() 
	        		+ Integer.parseInt(systemConfigurationDbRepository.getByTag("BEARER_TOKEN_EXPIRY_PERIOD").getValue())))
	  ...
	  private Key getSignInKey() {
		  byte[] keyBytes = Decoders.BASE64.decode(systemConfigurationDbRepository.getByTag("BEARER_TOKEN_KEY").getValue());
